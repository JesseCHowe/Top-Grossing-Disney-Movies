...
const years = d3
  ...
  .attr("viewBox", "0 0 100 20000");

const disney = d3
  .select("#disney")
  .append("svg")
  .attr("preserveAspectRatio", "xMinYMin meet")
  .attr("viewBox", "0 0 1200 20000");
...
disney
  ...
  .on("mousemove", function (event, d) {
    ...
    let studioText;
    d.studio
      ? (studioText = `<b><span class="desc">Studio:</span> ${d.studio}`)
      : (studioText = "");
    tooltip
      .style("display", "block")
      ...
      .html(
        "<div>" +
          ...
          "</strong>" +
          "<br>" +
          '<span class="desc">Adjusted Gross:</span> ' +
          formatMoney(d.inflation_adjusted_gross) +
          "<br>" +
    ...
    if (w > 700) {
      ...
      event.x < w / 2
        ...
        : tooltip.style("left", event.x - 270 + "px");
    } else {
      tooltip
        .style("bottom", 0)
        .style("left", 0)
